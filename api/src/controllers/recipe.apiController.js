...
const findAllApiRecipe = async () => {
  const lola = axios
    .get(
      `https://api.spoonacular.com/recipes/complexSearch?apiKey=6763f67742c64f69bc55a3cb4863ed11&addRecipeInformation=true&number=100`
...
const RecipeByIdApi = async (id) => {
  ...
  try {
    const { data } = await axios.get(
      `https://api.spoonacular.com/recipes/${id}/information?apiKey=6763f67742c64f69bc55a3cb4863ed11`
    );
    let aryApi = {
      id: data.id,
      name: data.title,
...
const findAllDishTypes = async () => {
  try {
    const { data } = await axios.get(
      `https://api.spoonacular.com/recipes/complexSearch?apiKey=6763f67742c64f69bc55a3cb4863ed11&addRecipeInformation=true&number=40`
    );
